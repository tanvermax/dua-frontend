...
export default function MainDua() {
    const [dua, setDua] = useState<DuaItem[]>([]);
    ...
    return (
        <div className=" min-h-screen bg-[#f9fafb] text-gray-800 px-14 py-8  mx-auto space-y-6">
                    ...
                    <section className='bg-[#EEF6EB]'>
                        <p className="text-sm text-gray-500 mb-2 flex gap-2">
...

                            {
                                subCategory
                                    .filter((subcat) => {
                                        // Extract first two words from both names
                                        const subcatWords = subcat.subcat_name_en?.split(' ').slice(0, 1).join(' ').toLowerCase();
                                        const duaWords = duaData.dua_name_en?.split(' ').slice(0, 1).join(' ').toLowerCase();

                                        return subcatWords === duaWords;
                                    })
                                    .map((subcat) => (
                                        <p key={subcat.subcat_id}>{subcat.subcat_name_en}</p>
                        ...
                        <div className="  flex space-x-10 text-gray-500 text-lg">
                            <span className="cursor-pointer">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M10.0001 6.57501L9.10838 8.12501C8.90838 8.46668 9.07505 8.75001 9.46672 8.75001H10.5251C10.9251 8.75001 11.0834 9.03335 10.8834 9.37501L10.0001 10.925" stroke="#709484" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M6.91672 15.0333V14.0667C5.00005 12.9083 3.42505 10.65 3.42505 8.25C3.42505 4.125 7.21672 0.891671 11.5 1.825C13.3834 2.24167 15.0334 3.49167 15.8917 5.21667C17.6334 8.71667 15.8 12.4333 13.1084 14.0583V15.025C13.1084 15.2667 13.2 15.825 12.3084 15.825H7.71672C6.80005 15.8333 6.91672 15.475 6.91672 15.0333Z" stroke="#709484" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M7.08337 18.3333C8.99171 17.7916 11.0084 17.7916 12.9167 18.3333" stroke="#709484" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            ...
                            <span className="cursor-pointer">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M14.0167 1.66669H5.98339C4.20839 1.66669 2.76672 3.11669 2.76672 4.88335V16.625C2.76672 18.125 3.84172 18.7584 5.15839 18.0334L9.22506 15.775C9.65839 15.5334 10.3584 15.5334 10.7834 15.775L14.8501 18.0334C16.1667 18.7667 17.2417 18.1334 17.2417 16.625V4.88335C17.2334 3.11669 15.7917 1.66669 14.0167 1.66669Z" stroke="#709484" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>

                            </span>
                            <span className="cursor-pointer">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3.33337 10V7.03335C3.33337 3.35001 5.94171 1.84168 9.13337 3.68335L11.7084 5.16668L14.2834 6.65001C17.475 8.49168 17.475 11.5083 14.2834 13.35L11.7084 14.8333L9.13337 16.3167C5.94171 18.1583 3.33337 16.65 3.33337 12.9667V10Z" stroke="#709484" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>

                            </span>
                            <span className="cursor-pointer"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.66663 1.66669V4.16669" stroke="#709484" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M13.3334 1.66669V4.16669" stroke="#709484" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M2.91663 7.57501H17.0833" stroke="#709484" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M17.5 7.08335V14.1667C17.5 16.6667 16.25 18.3334 13.3333 18.3334H6.66667C3.75 18.3334 2.5 16.6667 2.5 14.1667V7.08335C2.5 4.58335 3.75 2.91669 6.66667 2.91669H13.3333C16.25 2.91669 17.5 4.58335 17.5 7.08335Z" stroke="#709484" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M13.079 11.4167H13.0864" stroke="#709484" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M13.079 13.9167H13.0864" stroke="#709484" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M9.9962 11.4167H10.0037" stroke="#709484" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M9.9962 13.9167H10.0037" stroke="#709484" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M6.91197 11.4167H6.91945" stroke="#709484" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M6.91197 13.9167H6.91945" stroke="#709484" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                            </span>

                            <span>
                                <svg width="4" height="16" viewBox="0 0 4 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1.99996 8.83331C2.4602 8.83331 2.83329 8.46022 2.83329 7.99998C2.83329 7.53974 2.4602 7.16665 1.99996 7.16665C1.53972 7.16665 1.16663 7.53974 1.16663 7.99998C1.16663 8.46022 1.53972 8.83331 1.99996 8.83331Z" stroke="#709484" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M1.99996 2.99998C2.4602 2.99998 2.83329 2.62688 2.83329 2.16665C2.83329 1.70641 2.4602 1.33331 1.99996 1.33331C1.53972 1.33331 1.16663 1.70641 1.16663 2.16665C1.16663 2.62688 1.53972 2.99998 1.99996 2.99998Z" stroke="#709484" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M1.99996 14.6666C2.4602 14.6666 2.83329 14.2935 2.83329 13.8333C2.83329 13.3731 2.4602 13 1.99996 13C1.53972 13 1.16663 13.3731 1.16663 13.8333C1.16663 14.2935 1.53972 14.6666 1.99996 14.6666Z" stroke="#709484" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
